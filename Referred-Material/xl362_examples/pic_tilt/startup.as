	...
	; Compiler options:
	;
	; -oxl362_tilt.cof -mxl362_tilt.map --summary=default --output=default \
	; xl362_tilt_main.p1 xl362_io_pic.p1 --chip=16F84 \
	; -IC:\projects\xl362_examples\lib\inc -P --runtime=default \
